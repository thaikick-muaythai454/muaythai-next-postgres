          ...
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 bg-zinc-800 hover:bg-zinc-700 px-4 py-3 rounded-lg text-white transition-colors"
              >
              ...
              {isDropdownOpen && (
                <div className="absolute bg-zinc-800 shadow-lg mt-2 border border-zinc-700 rounded-lg w-full">
