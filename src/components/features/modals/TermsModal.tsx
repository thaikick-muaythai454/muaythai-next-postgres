    ...
    <div className="z-50 fixed inset-0 flex justify-center items-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
      <div className="relative bg-zinc-950 shadow-2xl rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-slideUp">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-1 text-red-100 text-sm">
                กรุณาอ่านและยอมรับเงื่อนไขก่อนส่งใบสมัคร
              </p>
            </div>
            <button
              onClick={handleClose}
        ...
        <div className="px-6 py-6 max-h-[calc(90vh-220px)] overflow-y-auto">
            ...
            <div className="space-y-6 text-zinc-300">
                ...
                <div className="space-y-4">
                  <div className="bg-zinc-950 p-4 border-blue-500 border-l-4 rounded-lg">
                    ...
                    <p className="text-zinc-300 text-sm leading-relaxed">
                      ...
                      กิจกรรม หรือบนแพลตฟอร์มของ thaikickmuaythai.com
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-950 p-4 border-green-500 border-l-4 rounded-lg">
                    ...
                    <p className="text-zinc-300 text-sm leading-relaxed">
                      ...
                      <span className="font-medium text-red-400">
                        โฆษณา การสร้างแบรนด์ การส่งเสริมการขาย
                        และการประชาสัมพันธ์
                      </span>{" "}
                      ของ thaikickmuaythai.com ในทุกช่องทาง ทั้งในและต่างประเทศ{" "}
                      <span className="font-medium text-yellow-400">
                        โดยไม่มีข้อจำกัดด้านระยะเวลา
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-950 p-4 border-purple-500 border-l-4 rounded-lg">
                    ...
                    <p className="text-zinc-300 text-sm leading-relaxed">
                      ...
                      ใด ๆ จาก thaikickmuaythai.com
                      ที่เกิดจากการใช้ภาพลักษณ์และข้อมูลเพื่อการตลาดดังกล่าว
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-950 p-4 border-orange-500 border-l-4 rounded-lg">
                    ...
                    <p className="text-zinc-300 text-sm leading-relaxed">
                      ...
                      ของ thaikickmuaythai.com แล้วก็ตาม
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-zinc-700 border-t">
                ...
                <div className="bg-zinc-950/50 p-4 rounded-lg">
                  <p className="mb-3 text-zinc-300 text-sm leading-relaxed">
                    เมื่อคุณยอมรับเงื่อนไขนี้ thaikickmuaythai.com สามารถนำภาพ
                  ...
                  <ul className="space-y-2 text-zinc-300 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        โฆษณาบนโซเชียลมีเดีย (Facebook, Instagram, TikTok,
                        YouTube)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
              ...
              <div className="mt-6 pt-6 border-zinc-700 border-t">
                ...
                <div className="space-y-3">
                  <div className="bg-linear-to-r from-yellow-900/20 to-orange-900/20 p-4 border border-yellow-700/50 rounded-lg">
                    <p className="text-zinc-300 text-sm leading-relaxed">
                  ...
                  <div className="bg-linear-to-r from-blue-900/20 to-cyan-900/20 p-4 border border-blue-700/50 rounded-lg">
                    <p className="text-zinc-300 text-sm leading-relaxed">
                  ...
                  <div className="bg-linear-to-r from-purple-900/20 to-pink-900/20 p-4 border border-purple-700/50 rounded-lg">
                    <p className="text-zinc-300 text-sm leading-relaxed">
          ...
          {/* Gym-specific Terms */}
          <div className="bg-linear-to-br from-zinc-900 to-zinc-800 mb-6 p-6 border border-red-600 rounded-xl">
            ...
            <label className="group flex items-start gap-4 bg-zinc-950 p-4 border border-zinc-700 hover:border-red-500 rounded-lg transition-all cursor-pointer">
              ...
              <div className="flex-1">
                <p className="font-semibold group-hover:text-red-400 text-base transition-colors">
                  ข้าพเจ้าได้อ่านและยอมรับ ข้อตกลงและเงื่อนไขการใช้บริการ และ
                  นโยบายความเป็นส่วนตัว
                </p>
                <p className="mt-2 text-zinc-400 text-sm">
                  การยอมรับเงื่อนไขนี้เป็นข้อบังคับ
                  และจำเป็นต้องทำก่อนส่งใบสมัคร
                </p>
              </div>
            </label>

            {/* Marketing Consent */}
            <label className="group flex items-start gap-4 bg-linear-to-br from-red-900/20 to-orange-900/20 p-4 border border-red-700 hover:border-red-500 rounded-lg transition-all cursor-pointer">
              <input
                type="checkbox"
          ...
          {!acceptedTerms && (
            <div className="bg-yellow-900/20 mt-4 p-4 border border-yellow-600 rounded-lg">
              <div className="flex items-start gap-3">
                <svg
                  className="shrink-0 mt-0.5 w-6 h-6 text-yellow-500"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
                ...
                <p className="text-yellow-300 text-sm">
                  ...
                  คุณจำเป็นต้องยอมรับเงื่อนไขการให้บริการและนโยบายความเป็นส่วนตัวก่อนส่งใบสมัคร
                </p>
              </div>
            </div>
          )}
