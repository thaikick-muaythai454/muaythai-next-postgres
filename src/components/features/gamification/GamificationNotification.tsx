  ...
  return (
    <div className={`fixed top-4 right-4 z-50 space-y-2 ${className}`}>
      {notifications.map((notification) => (
        ...
        >
          <div className={`${getNotificationColor(notification.type)} text-text-primary rounded-lg shadow-lg p-4 max-w-sm`}>
            <div className="flex items-start justify-between">
              ...
              <button
                ...
                className="text-text-primary hover:text-gray-200 transition-colors"
              >
