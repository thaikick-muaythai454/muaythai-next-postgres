...
export interface GridProps
  extends Omit<
    ...
    "gap" | "padding" | "margin" | "maxWidth" | "centered"
  > {
  /**
...
export const Grid = React.forwardRef<HTMLDivElement, GridProps>(
  (
    ...
    const gapClasses = getResponsiveClasses(
      gap as ResponsiveValue<SpacingVariant | undefined>,
      getGapClasses
    );
    const rowGapClasses = rowGap
      ? getResponsiveClasses(
          rowGap as ResponsiveValue<SpacingVariant | number | undefined>,
          getRowGapClasses
        )
      : "";
    const colGapClasses = colGap
      ? getResponsiveClasses(
          colGap as ResponsiveValue<SpacingVariant | number | undefined>,
          getColGapClasses
        )
      : "";
    const autoFitClasses = autoFit
      ? getResponsiveClasses(
          autoFit as ResponsiveValue<
            "xs" | "sm" | "md" | "lg" | "xl" | undefined
          >,
          (val) => getAutoFitClasses(val as "xs" | "sm" | "md" | "lg" | "xl")
        )
      : "";
    const autoFillClasses = autoFill
      ? getResponsiveClasses(
          autoFill as ResponsiveValue<
            "xs" | "sm" | "md" | "lg" | "xl" | undefined
          >,
          (val) => getAutoFillClasses(val as "xs" | "sm" | "md" | "lg" | "xl")
        )
      : "";
    ...
    const gridClasses = cn(
      ...
      "grid",
      // Dense packing
      dense ? "grid-flow-dense" : undefined,

      // Columns (priority: autoFit > autoFill > cols)
      autoFitClasses || autoFillClasses || colsClasses || undefined,
      // Gap (specific gaps override general gap)
      !rowGap && !colGap ? gapClasses : undefined,
      rowGapClasses || undefined,
      colGapClasses || undefined,
      // Custom classes
      className
    );
