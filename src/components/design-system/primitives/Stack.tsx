 ...
 */
export interface StackProps extends Omit<LayoutComponentProps, 'direction' | 'align' | 'justify' | 'gap'> {
  /**
   * Stack direction
   */
 ...
 */
const getAlignClasses = (align: AlignmentVariant | 'justify' | undefined): string => {
...
export const Stack = React.forwardRef<HTMLDivElement, StackProps>(
  (
    ...
    const directionClasses = getResponsiveClasses(direction, (dir) => getDirectionClasses(dir as 'vertical' | 'horizontal', reverse as boolean));
    const gapClasses = getResponsiveClasses(gap, (gap) => getGapClasses(gap as SpacingVariant | number));
    const alignClasses = getResponsiveClasses(align, (align) => getAlignClasses(align as AlignmentVariant | 'justify'));
