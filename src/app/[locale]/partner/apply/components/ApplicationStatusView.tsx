...
export const ApplicationStatusView = ({
  ...
  > = {
    pending: {
      bg: "bg-linear-to-br from-yellow-500/20 to-orange-500/20",
    ...
    approved: {
      bg: "bg-linear-to-br from-green-500/20 to-emerald-500/20",
    ...
    denied: {
      bg: "bg-linear-to-br from-red-500/20 to-rose-500/20",
  ...
  return (
    <div className="bg-linear-to-br from-zinc-950 via-zinc-900 to-zinc-950 min-h-screen relative overflow-hidden text-white">
      {/* Background Effects */}
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-5xl relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="relative inline-block mb-8">
            <div className="absolute inset-0 bg-linear-to-r from-red-500 to-red-700 rounded-full blur-lg opacity-30 animate-pulse"></div>
            <div className="relative inline-flex items-center justify-center w-24 h-24 bg-linear-to-br from-red-500 via-red-600 to-red-700 rounded-full shadow-2xl">
              <span className="text-4xl animate-bounce">{status.icon}</span>
            </div>
            <div className="absolute -top-2 -right-2 w-6 h-6 bg-yellow-400 rounded-full animate-ping"></div>
          </div>

          <h1 className="font-bold text-transparent bg-clip-text bg-linear-to-r from-white via-red-100 to-white text-5xl md:text-6xl mb-6 animate-fade-in">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-linear-to-r from-red-500 to-red-700 rounded-full"></div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 relative z-10">
            ...
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="relative w-full bg-zinc-800/50 rounded-full h-3 shadow-inner">
                <div
                  className={`h-3 rounded-full transition-all duration-2000 ease-out relative overflow-hidden ${
                    status.progress === 100
                      ...
                      : status.progress === 50
                        ? "bg-linear-to-r from-yellow-400 via-orange-500 to-yellow-600"
                ...
                <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/10 to-transparent rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {/* Basic Information */}
          <div className="group bg-linear-to-br from-zinc-900/60 to-zinc-800/40 backdrop-blur-md border border-zinc-700/50 rounded-3xl p-8 shadow-2xl hover:shadow-red-500/10 transition-all duration-300 hover:border-red-500/30">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-linear-to-br from-red-500/20 to-red-600/20 rounded-2xl border border-red-500/30">
          ...
          <div className="group bg-linear-to-br from-zinc-900/60 to-zinc-800/40 backdrop-blur-md border border-zinc-700/50 rounded-3xl p-8 shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 hover:border-blue-500/30">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-linear-to-br from-blue-500/20 to-blue-600/20 rounded-2xl border border-blue-500/30">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-6">
                <div className="relative w-4 h-4 mt-2">
                  <div className="absolute inset-0 bg-linear-to-r from-green-400 to-emerald-500 rounded-full shadow-lg"></div>
              ...
              {applicationStatus === "pending" && (
                <div className="flex items-start gap-6">
                  <div className="relative w-4 h-4 mt-2">
                    <div className="absolute inset-0 bg-linear-to-r from-yellow-400 to-orange-500 rounded-full shadow-lg animate-pulse"></div>
        ...
        {/* Services and Images */}
        <div className="group bg-linear-to-br from-zinc-900/60 to-zinc-800/40 backdrop-blur-md border border-zinc-700/50 rounded-3xl p-8 mb-12 shadow-2xl hover:shadow-purple-500/10 transition-all duration-300 hover:border-purple-500/30">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-linear-to-br from-purple-500/20 to-purple-600/20 rounded-2xl border border-purple-500/30">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {existingGym.services && existingGym.services.length > 0 && (
              <div className="space-y-6">
                <h3 className="flex items-center gap-3 font-bold text-white text-xl">
                  <div className="p-2 bg-linear-to-br from-orange-500/20 to-orange-600/20 rounded-xl border border-orange-500/30">
                ...
                <div className="flex flex-wrap gap-3">
                  {existingGym.services.map((service, index) => (
                    <span
                      key={index}
                      className="group/tag bg-linear-to-r from-red-500/20 to-red-600/20 px-4 py-2 border border-red-500/30 rounded-2xl text-red-400 text-sm font-semibold hover:from-red-500/30 hover:to-red-600/30 hover:border-red-500/50 transition-all duration-200 hover:scale-105 cursor-default"
                    >
                      {service}
                    </span>
                  ))}
            ...
            {existingGym.images && existingGym.images.length > 0 && (
              <div className="space-y-6">
                <h3 className="flex items-center gap-3 font-bold text-white text-xl">
                  <div className="p-2 bg-linear-to-br from-blue-500/20 to-blue-600/20 rounded-xl border border-blue-500/30">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          {applicationStatus === "approved" && (
            ...
            >
              <div className="absolute inset-0 bg-linear-to-r from-green-400 to-emerald-400 rounded-2xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-300"></div>
          ...
          {applicationStatus === "pending" && (
            <div className="text-center space-y-6">
              <div className="bg-linear-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-2xl p-6">
                <p className="text-white text-lg mb-4">
                  มีคำถามหรือต้องการติดต่อทีมงาน?
                </p>
                <Link
                  href="mailto:support@thaikick-muaythai.com"
                  className="group inline-flex items-center gap-3 bg-linear-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 px-8 py-3 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25"
                >
          ...
          {applicationStatus === "denied" && (
            <div className="text-center space-y-6">
              <div className="bg-linear-to-r from-red-500/10 to-rose-500/10 border border-red-500/30 rounded-2xl p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="mailto:support@thaikick-muaythai.com"
                    className="group inline-flex items-center gap-3 bg-linear-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 px-6 py-3 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25"
                  >
                  ...
                  <Link
                    ...
                    className="group inline-flex items-center gap-3 bg-linear-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 px-6 py-3 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-yellow-500/25"
                  >
                    <span className="text-lg">🔄</span>
                    <span>ลองใหม่</span>
                  </Link>
          ...
          <Link
            href="/"
            className="group inline-flex items-center gap-3 bg-linear-to-r from-zinc-600 to-zinc-700 hover:from-zinc-700 hover:to-zinc-800 px-8 py-3 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
          >
            <span className="text-lg">🏠</span>
