        ...
        <div className="gap-6 grid grid-cols-1 md:grid-cols-4">
          <Card className="bg-default-100/50 backdrop-blur-sm border-none">
            <CardBody>
              ...
              <p className="font-bold text-white text-3xl">{users.length}</p>
            </CardBody>
          </Card>
          <Card className="bg-default-100/50 backdrop-blur-sm border-none">
            <CardBody>
        ...
        <Card className="bg-default-100/50 backdrop-blur-sm border-none">
          <CardBody>
            <div className="flex sm:flex-row flex-col justify-between items-start sm:items-center gap-4 mb-6">
              <h2 className="font-bold text-white text-xl">รายชื่อผู้ใช้</h2>
              <Input
              ...
              <TableBody emptyContent="ไม่พบข้อมูลผู้ใช้">
                {users.map((userRole) => (
                  <TableRow key={userRole.user_id}>
                    <TableCell className="font-mono text-white text-sm">{userRole.user_id}</TableCell>
