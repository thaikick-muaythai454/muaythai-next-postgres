...
test.skip('Database utilities script validation is executed via dedicated runner', () => {});
...
module.exports = DatabaseUtilitiesTester;
module.exports.default = DatabaseUtilitiesTester;
