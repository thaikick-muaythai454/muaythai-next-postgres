...
- ❌ ระบบจัดการจำนวนตั๋ว (มี API แล้ว แต่ยังไม่มี UI)
- ❌ ระบบเลือกที่นั่ง
...
- [ ] สร้าง UI สำหรับระบบจัดการตั๋ว/Inventory (มี API แล้ว)
- [ ] สร้างระบบเลือกที่นั่ง
- [ ] สร้าง QR Code สำหรับเข้างาน (มี check-in API แล้ว)
- [ ] สร้าง UI สำหรับระบบ Check-in (มี API แล้ว)
- [ ] สร้าง API และ UI สำหรับหมวดหมู่อีเวนต์ (มีตารางแล้ว)
